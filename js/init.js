...
function edrea_tm_team_popup(){
	
	"use strict";
	
	var modalBox		= jQuery('.edrea_tm_modalbox');
	var button			= jQuery('.edrea_tm_team .team_popup');
	...
	button.off().on('click',function(){
		...
		modalBox.find('.team_popup_details').prepend('<div class="top_image"><img src="img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
		modalBox.find('.team_popup_details .top_image').after('<div class="team_main_title"><h3>'+title+'</h3><span><a href="#">'+category+'</a></span><div>');
		edrea_tm_data_images();
		edrea_tm_popup();
		return false;
	});
